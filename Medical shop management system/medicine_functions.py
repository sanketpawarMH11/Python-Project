...
def add_medicine():
    ...
    print('New medicine inserted Successfully')
    ...
    with open('purchase.csv', 'a+') as csvfile:
        ...
        writer.writerow(
            {'medi_name': medi_name, 'med_id': med_id, 'unit': unit, 'quantity': quantity, 'pur_date': pur_date,
             'pur_month': pur_month, 'pur_year': pur_year, 'sup_id': sup_id, 'cost': cost})

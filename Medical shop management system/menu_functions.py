...
def customer_menu():
    ...
    while(c_menu_choice!=4):
        ...
        print('----------------------------------')
        print('|Enter 4 for Customer list |')
        print('----------------------------------')
        print('|Enter 5 to go back to main menu |')
        print('----------------------------------')
        ...
        if(c_menu_choice==1):
           customer_functions.search_customer()
            ...
            customer_functions.list_info()
        elif c_menu_choice==5:
            break
        else:
            print("Invalid Input! Try Again!\n")
def supplier_menu():
    ...
    while(s_menu_choice!=4):
        ...
        print('----------------------------------')
        print("| Enter 3 to update supplier information. |")
        print('----------------------------------')
        print("| Enter 4 to list of supplier. | ")
        print('----------------------------------')
        print("| Enter 5 to go back to Main Menu. | \n ")
        ...
        if(s_menu_choice==1):
            ...
            supplier_functions.list_supplier_info()
        elif s_menu_choice==5:
            break
        else:
            print("Invalid Input! Try Again!\n")
def report_menu():
    ...
    while(r_menu_choice!=6):
        ...
        if(r_menu_choice==1):
            ...
            report_functions.monthly_purchase()

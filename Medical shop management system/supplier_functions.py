...
def create_supplier():
        with open('supplier.csv', 'a+') as csvfile:
                ...
                with open('supplier.csv', 'r+') as csfile:
...
def search_supplier():
        ...
        while(ss_choice!=3):
                ...
                print('---------------------------------------------')
                print("|Enter 2 to exit supplier search!           |")
                print('---------------------------------------------')
...
def list_supplier_info():
    ...
    with open('supplier.csv', 'r+') as csfile:
        ...
        for row in reader:
            if row['sup_name']!='' :
                count += 1
                print(' Supplier Name:',row['sup_name'],'\n','Supplier_id:',row['sup_id'],'\n','Supplier_city :',row['sup_city'],'\n','Supplier_Contact:',row['sup_contact'],'\n','supplier_email:',row['sup_email'],'\n')
    if count == 0:
